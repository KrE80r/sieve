...
class FeedSieve {
    ...
    _showModalAtIndex(index) {
        ...
        const scrollable = content; // .modal-content is the scrolling container
        ...
        content.addEventListener('touchstart', (e) => {
            ...
            deltaY = 0;
            swiping = null;
            // Only allow swipe-to-dismiss if already at top when touch starts
            startedAtTop = scrollable.scrollTop <= 0;
        }, { passive: true });
        ...
        content.addEventListener('touchmove', (e) => {
            ...
            // Vertical swipe-to-dismiss (only when started at top and pulling down)
            if (swiping === 'vertical' && deltaY > 0 && startedAtTop && scrollable.scrollTop <= 0) {
        ...
        content.addEventListener('touchend', () => {
            if (swiping === 'vertical' && deltaY > 100 && startedAtTop && scrollable.scrollTop <= 0) {
                history.back();
